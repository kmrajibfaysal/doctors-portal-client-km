                ...
                <div className="mt-16 w-full rounded-xl bg-white  p-10 shadow md:w-1/2 lg:w-1/3">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            role="input"
                            type="text"
                            className="text-md border-root mt-2 w-full rounded border bg-gray-100 py-3 pl-3 font-medium leading-none text-gray-800 focus:outline-none "
                        />
                    </div>
                    <div>
                        <label className="text-sm font-medium leading-none text-gray-800">
                    ...
                    <div className="mt-8">
                        ...
                        <button
                            ...
                            role="button"
                            aria-label="Login"
                            className="text-md border-root text-root hover:bg-root focus:ring-root w-full rounded border py-4 font-bold leading-none hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2"
                        >
                            Sign up
                        </button>
                    </div>
